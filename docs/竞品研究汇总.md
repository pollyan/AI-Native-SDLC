...
### 2.8 agent-skills（addyosmani/agent-skills）— 设计模式
...
| 22 | Anti-Rationalization | agent-skills | ⚠️ 计划中 | 短期增强 Phase 2 |
| 23 | Doubt-Driven Development | agent-skills | ⚠️ 计划中 | 短期增强 Phase 2 |
| 24 | Source-Driven Development | agent-skills | ⚠️ 计划中 | 短期增强 Phase 2 |
